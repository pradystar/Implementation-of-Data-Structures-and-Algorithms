...
public class ReverseLinkedList<E> {
    ...
    /**
     * logic: create new list from the right most node of the list.
     * move head to right of the list with every recursive call until there is only one node left,
     * then add the head to the reverse list (since everything after head is already in reverse list
     * base case: list with one node, nothing to reverse so add to reverse list
     * @param head : head node of the list
     * @param rev : empty reverse list which is the output
     */
    private void reverseList(SinglyLinkedList.Entry<E> head,  SinglyLinkedList<E> rev){
        //call the function reverseList recursively moving head to right by one node
     ...
     * This is the helper function to call reverseList() recursive function
     * @param l
     ...
     * using 3 pointers: prevNode(previous node), curNode(current node) and nextNode
     * reverse the link between prevNode and curNode and move to right of the list
     * after all links are reversed, move the head to point to the prevNode (which is the first node in reversed list)
     * @param l : input list
     * @return reversed SinglyLinked list
     */
    ...
    /**
     * logic: move head to right of the list with every recursive call until there is only one node left,
     * then print the head node's element
     * base case: list with one node, nothing to reverse so add to reverse list
     * @param head : head node of the input list
     */
    ...
    /**
     * function to reverse list recursively
     * This is the helper function to call reversePrint() recursive function
     * @param l : input list
     */
    ...
    /**
     * function to print the list in reversed order iteratively
     * using an external stack store all the elements as we traverse from left to right
     * print the stack
     * @param l : input list
     */
