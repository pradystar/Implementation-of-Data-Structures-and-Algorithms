...
public class SetOperations {
    ...
    /**
     * The function will update outList with elements common to both l1 and l2 in sorted order
     *
     * @param l1      : list implementing sorted sets
     * @param l2      : list implementing sorted sets
     * @param outList : An empty list
     */
    ...
    /**
     * The function will perform union operation on l1 and l2 and store the results in outList without any duplicates
     *
     * @param l1      : list implementing sorted sets
     * @param l2      : list implementing sorted sets
     * @param outList : An empty list
    ...
    /**
     * The function will perform difference operation on l1 and l2 i.e, items in l1 that are not in l2, and store
     * result in outList in sorted order
     *
     * @param l1      : list implementing sorted sets
     * @param l2      : list implementing sorted sets
     * @param outList : An empty list
     ...
     *
     * @param it : Iterator of type T
     * @return : T : next item in the list on which the iterator is invoked or null if the list has no more elements
     */
    ...
    public static void main(String[] args) {
        ...
        List<Integer> iout = new ArrayList<>(); // List storing output of the intersect set operations
        List<Integer> uout = new ArrayList<>(); // List storing output of the union set operations
        List<Integer> dout = new ArrayList<>(); // List storing output of the difference set operations
        List<String> siout = new ArrayList<>(); // List storing output of the intersect set operations
        List<String> suout = new ArrayList<>(); // List storing output of the union set operations
        List<String> sdout = new ArrayList<>(); // List storing output of the difference set operations
        Timer t = new Timer();
